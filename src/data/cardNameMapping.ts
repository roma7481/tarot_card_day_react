...
export const CARD_NAME_TO_ID: Record<string, string> = Object.entries(CARD_NAME_MAPPING).reduce((acc, [id, name]) => {
    acc[name] = id;
    return acc;
